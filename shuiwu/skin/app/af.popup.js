    ...
    var popup = (function () {
        var popup = function (containerEl, opts) {
            ...
            try {
                ...
                this.hiddeHeader = opts.hiddeHeader||false;
                this.hiddeFooter = opts.hiddeFooter||false;
            ...
            show: function () {
                ...
                $el.find("A").each(function () {
                    ...
                    button.bind("click", function (e) {
						...
						var doneTextStr=$("#action").html();
						if(doneTextStr.indexOf("(")===-1){
