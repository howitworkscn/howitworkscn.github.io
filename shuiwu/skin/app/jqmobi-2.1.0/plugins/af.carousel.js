...
(function($) {
    ...
    var carousel = (function() {
        ...
        var carousel = function(containerEl, opts) {
            ...
            if (this instanceof carousel) {
                ...
                while(data.length>0)
                {
                    ...
                    if(myEl.get()==el||myEl[0].nodeType==3)
                       continue;
                    $el.append(myEl.get());
                }
                if (this.horizontal) {
        ...
        carousel.prototype = {
              ...
              //  try {
               ...
               // }
                ...
                if (runFinal && this.pagingFunction && typeof this.pagingFunction == "function")
                    this.pagingFunction(this.carouselIndex,this.el.childNodes[this.carouselIndex]);
            },
            ...
            next:function(transitionTime){
                this.onMoveIndex(this.carouselIndex+1,transitionTime);
            },
            prev:function(transitionTime){
                this.onMoveIndex(this.carouselIndex-1,transitionTime);
            },
            ...
            refreshItems: function() {
                ...
                if (this.pagingDiv) {
                    ...
                    for (i = 0; i < this.childrenCount; i++) {
                        ...
                        if(this.horizontal){
                            pagingEl.style.display = "inline-block";
                        }else{
                    ...
                    if(this.horizontal){
                    	this.pagingDiv.style.display = "inline-block";
                        $(this.pagingDiv).width($(window).width());
                        this.pagingDiv.style.height = "25px";
                    }
                    else {
                    	this.pagingDiv.style.display = "block";
